...
#  if _WIN32
#    if defined(__GNUC__)
#       define cb_cc(cmd) cb_append(cmd, STR_LIT("cc"))
#    elif defined(__clang__)
#       define cb_cc(cmd) cb_append(cmd, STR_LIT("clang"))
#    elif defined(_MSC_VER)
#       define cb_cc(cmd) cb_append(cmd, STR_LIT("cl.exe"))
#    elif defined(__TINYC__)
#       define cb_cc(cmd) cb_append(cmd, STR_LIT("tcc"))
#    endif
#  else
#    define cb_cc(cmd) cb_append(cmd, STR_LIT("cc"))
#  endif
...
void cb_append(command *cmd, string str_to_append) {
    ...
    string prefix = STR_LIT("cmd.exe /c");
